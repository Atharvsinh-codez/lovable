...
import { loadTemplate } from '@/lib/templates/template-storage';
...
export async function GET(
  ...
  try {
    ...
    console.log('[load-template] Loading template:', templateId, 'type:', artifactType);
    
    const template = await loadTemplate(workspaceId, artifactType, templateId);
